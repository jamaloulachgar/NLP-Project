...
export function HelpPanel({ onSelectQuery }: HelpPanelProps) {
  ...
  const queries = exampleQueries[displayLang];
  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden sm:inline">{t('chat.help', displayLang)}</span>
      </Button>
          ...
          <div className={cn(
            ...
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold">{t('chat.exampleQueries', displayLang)}</h3>
              </div>
