import { ExternalLink, Info, User, ThumbsUp, ThumbsDown, Copy, MoreVertical, RotateCcw } from 'lucide-react';
      ...
      <div className={cn("flex flex-col gap-2 max-w-[80%]", isUser ? "items-end" : "items-start")}>
        <div className={cn(
          ...
          isUser 
            ...
            : "bg-chat-assistant text-chat-assistant-foreground rounded-ts-md"
        )}>
          {isUser ? (
